...
class DashboardScreen extends State<StatefulWidgetReg> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: MyDrawer(),
      body: WillPopScope( //prevents hitting the back button while in the main dashboard of the application
        onWillPop: () async {
          Future.value(false);
        },
        child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      height: 21,
                                      margin:
                                          EdgeInsets.only(left: 19, top: 12),
                                      child: Row(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.center,
                                        children: [
                                    ...
                                    Container(
                                      ...
                                      height: 21,
                                      margin:
                                          EdgeInsets.only(left: 19, bottom: 2),
                                      child: Row(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.center,
                                        children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      height: 21,
                                      margin:
                                          EdgeInsets.only(left: 18, bottom: 55),
                                      child: Row(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.center,
                                        children: [
